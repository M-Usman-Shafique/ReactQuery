...
const PostsRQ = () => {
    ...
    const { mutate } = useMutation({
        mutationFn: addPost,
        // Non-optimized way to display newly added post instantly:
        // onSuccess: () => {
        //     queryClient.invalidateQueries("posts"); // queryKey of useQuery()
        //     }

        // Optimized way to display newly added post instantly:
        // onSuccess: (newData) => {
